...
parser.add_argument('--num_epochs', type=int, default=150, help='Number of training epochs (default: 500)')
...
parser.add_argument('--finetune_epochs', type=int, default=200, help='Finetune epochs')
